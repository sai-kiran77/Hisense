...
SupportComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: SupportComponent, selectors: [["app-support"]], decls: 35, vars: 0, consts: [[1, "page"], [1, "breadcrumb__yellow__banner"], [1, "row", "support__container"], [1, "card"], [1, "card-image"], ["src", "assets/t_and_c.png"], [1, "card-content"], [1, "actions"], ["routerLink", "/terms-and-conditions", 1, "btn-hisense-v2"], ["src", "assets/support.png"], ["routerLink", "/contact-us", 1, "btn-hisense-v2"], ["src", "assets/offers.png"], ["routerLink", "/warranty-information", 1, "btn-hisense-v2"]], template: function SupportComponent_Template(rf, ctx) { if (rf & 1) {
